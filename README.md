...
> *Voltron Evaluation*: Diverse Evaluation Tasks for Robotic Representation Learning – Spanning Grasp Affordance Prediction, Referring Expression Grounding, Visuomotor Control, and beyond!

Package repository for Voltron Evaluation: Diverse Evaluation Tasks for Robotic Representation Learning.
...
```bash
git clone https://github.com/siddk/voltron-evaluation
cd voltron-evaluation
pip install -e .
```
...
+ `voltron_evaluation` - Package source code; has all core utilities for model specification, loading,
                               preprocessing, etc.
